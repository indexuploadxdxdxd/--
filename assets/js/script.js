...
function openSocial(type) {
  ...
  switch (type) {
    case 'discord':
      url = 'https://discord.com/users/848791680236257291';
      break;
    case 'github':
      url = 'https://github.com/haxuu1337';
      break;
    case 'twitter':
      url = 'https://twitter.com/dkyuzi';
      break;
    case 'youtube':
      url = 'https://youtube.com/channel/UCUkdwCKFOSWNLOpZWktnXDg';
      break;
  }
...
function typerStartTyping(typer) {
  ...
  let text = ['Hello, im haxuu', '- CEO Saturn Botnet', 'Saturn Discord > https://discord.gg/wdt5vD8xjW'];
